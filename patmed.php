...
<header>
    ...
    <div class="container">
      ...
      <form action="" method="post">
          ...
          <input type="text" name="treatment" id="treatment" placeholder="current treatment">
      ...
      <a href="pathis.html">
          <button class="bttn" a >After submitting , click here to view history</button>
          </a>
...
// }
    ...
    $sql="INSERT INTO `MhPhYxUSqu`.`medhistory` (`name`, `treatment`, `status`, `prescription`, `phone`, `Date`) VALUES ('$name', '$treatment', '$status', '$prescription', '$phone', CURRENT_TIMESTAMP);";
