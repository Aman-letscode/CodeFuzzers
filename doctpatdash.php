...
<br>
    ...
    <br>
        ...
        <h4 class="text-center">Click Here To view <button type="submit" class="btn btn-danger btn-sm"><a href="dochis.php"><h4 class="text-white">Medical History</h4></a></button> 
