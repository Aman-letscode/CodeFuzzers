...
$sql = "INSERT INTO `form`.`forms` ( `date`, `name`, `treatment`, `Status`, `Prescriptions`) VALUES ( '$date', '$name', '$treatment', '$Status', '$Prescriptions');";
// echo $sql;
...
$con  = mysqli_connect($server,$username,$password,$database);
if(!$con){
    die("not connected to databasa " . mysqli_connect_error());
}
//  echo "yes";
...
?>
                    ...
                    <tr>
                        ...
                        <td><a href="#"><img src="down.png" height="40"></a></td>
                    </tr>
                    <?php
   }
